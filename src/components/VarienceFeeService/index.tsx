      ...
      <motion.div ref={scrollRef} className="h-250vh w-full relative" style={{ backgroundColor }} >
        <div className="sticky top-0 z-20 h-screen overflow-hidden">
          <motion.div
            ...
            <motion.div className="text-black mt-40 z-20" style={{ color: textColor }}>
              <p className="font-bold text-5xl">시간별 변동 요금제로 매장 회전율 극대화</p>
              <motion.div className="flex flex-col items-center mt-10 font-light opacity-70" style={{ color: subTextColor }}>
                <p>바쁜 시간에는 기존 요금을</p>
            ...
            <motion.div className="absolute right-28 top-40" style={{ x: sunX }}>
            ...
            <motion.div className="absolute right-28 top-40" style={{ x: moonX }}>
