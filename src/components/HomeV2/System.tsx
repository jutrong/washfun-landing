  ...
  return (
    <div>
      ...
      >
        ...
        <motion.div variants={fadeUp} className="rounded-[24px] bg-secondaryForeground lg:h-[360px] ">
          <div className="flex flex-col gap-[4px] p-[24px]">
            ...
            <p className="text-[18px] font-normal leading-[28px] text-secondaryDefault lg:text-[14px] lg:leading-[20px]">
              지금껏 비수기의 뼈아픈 매출 감소를 감당하고 계셨나요? <br />이제 구독 고객 확보를 통해 비수기에도 고정된 매출을 만들고,
              걱정을 덜어보세요.
            </p>
          </div>
        ...
        >
          <div className="flex flex-col gap-[4px] ">
            ...
            <p className="text-[18px] font-normal leading-[28px] text-secondaryDefault lg:text-[14px] lg:leading-[20px]">
              세차를 특별한 일처럼 생각하게 하지 마세요.<br /> 항상 자연스럽게, 마치 습관처럼 점주님의 세차장을 방문하게 만들어보세요.
            </p>
          </div>
        ...
        >
          <div className="flex flex-col gap-[4px] p-[24px]">
            ...
            <p className="text-[18px] font-normal leading-[28px] text-secondaryDefault lg:text-[14px] lg:leading-[20px]">
              차에서 내리는 불편함, 복잡한 결제, 어려운 이용 방법은 이제 없습니다.<br /> 들어갔다 나오면 끝나는, 커피 주문보다 쉬운 세차
              경험으로 대체하세요.
            </p>
          </div>
      ...
      >
        ...
        <motion.div
          variants={fadeUp}
          className="flex h-[400px] flex-col items-start justify-between overflow-hidden rounded-[24px] bg-secondaryForeground p-[24px] lg:h-[360px]"
        >
          <div className="flex flex-col gap-[4px] ">
            <p className="text-[24px] font-semibold text-black lg:text-[18px]">손님을 가리지 않는 세차장</p>
            <p className="text-[18px] font-normal leading-[28px] text-secondaryDefault lg:text-[14px] lg:leading-[20px]">
              매번 RF 카드를 잃어버리는 고객, 현금을 들고오지 않아 세차를 미루는 고객.<br /> 이제 모두가 걱정 없이 세차장에 올 수 있게
              만들어보세요.
            </p>
          </div>
          <Image src="/images/v2/png/conversation.png" alt="system1" width={1200} height={1200} className="mx-auto h-auto w-[95%] lg:w-[120%]" />
        </motion.div>
        ...
        >
          <div className="flex flex-col gap-[4px] ">
            ...
            <p className="text-[18px] font-normal leading-[28px] text-secondaryDefault lg:text-[14px] lg:leading-[20px]">
              고객은 3분의 시간이 끝나면 단 3천원에도 추가 결제를 고심합니다.<br /> 이제 이용 시간의 상한을 없애고 객단가를 더욱 올려보세요.
            </p>
          </div>
          <div className="flex items-end gap-[16px] self-end lg:flex-col">
        ...
        >
          <div className="flex flex-col gap-[4px]">
            ...
            <p className="text-[18px] font-normal leading-[28px] text-secondaryDefault lg:text-[14px] lg:leading-[20px]">
              언제 왔다 간지 모르는 진상 고객, 매번 전화를 기다리고 있어야 하는 현금 포인트 충전.<br /> 포인트 충전 시스템과 점주용 관리
              시스템으로 안심하고 운영하세요.
            </p>
          </div>
          <Image src="/images/v2/png/circle.png" alt="system1" width={1000} height={1000} className="mx-auto h-auto w-3/6 lg:w-full" />
        </motion.div>
      </motion.div>
    </div>
  );
