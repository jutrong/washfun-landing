...
export default function Footer() {
  ...
  return (
    <div className="mt-[200px] flex flex-row justify-between pb-[120px] pt-[80px] lg:flex-col-reverse">
      <div>
      ...
      <div className="flex cursor-pointer gap-[80px] px-[80px] lg:mb-[48px] lg:flex-col  lg:gap-[24px] lg:px-0">
        <div>
        ...
        <div className="cursor-pointer">
          ...
          <div className="mt-[16px] flex flex-col gap-[12px]">
            <p className="text-[16px] font-normal text-secondaryDefault" onClick={() => router.push('/contact')}>온라인 문의하기</p>
        ...
        <div className="cursor-pointer">
          ...
          <div className="mt-[16px] flex flex-col gap-[12px]">
            <p className="text-[16px] font-normal text-secondaryDefault" onClick={() => router.push('/terms-of-service')}>서비스 이용약관</p>
            <p className="text-[16px] font-normal text-secondaryDefault" onClick={() => router.push('/terms-of-privacy')}>개인정보 처리방침</p>
            <p className="text-[16px] font-normal text-secondaryDefault" onClick={() => router.push('/terms-of-digital')}>전자상거래 표준약관</p>
          </div>
        </div>
      </div>
    </div>
