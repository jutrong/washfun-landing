      ...
      <div className="group relative h-[426px] w-full cursor-pointer overflow-hidden rounded-[20px]">
        ...
        <div className="absolute left-0 top-0 z-20 flex size-full flex-col items-center justify-center">
          <div className="flex flex-col items-center justify-center gap-[16px]">
            <p className="text-center text-[48px] font-bold text-white lg:text-[30px]">이젠, 고민보단 <br />행동이 필요할 때.</p>
            <p className="text-center text-[20px] font-normal leading-[28px] text-[#C4C7CC] lg:text-[16px] lg:leading-[24px]">이미 수 많은 매장들이 구독제를 도입하고<br /> 내년을 준비하고 있습니다.</p>
          </div>
