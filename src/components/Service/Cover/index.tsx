  ...
  return (
    <div className="relative h-screen w-full overflow-x-hidden ">
      <div className="absolute left-0 top-0 z-0 size-full">
        <Image src="/images/png/pc-background.png" fill priority sizes="100vw" alt="워시펀 세차장 솔루션 메인 배경" quality={90} style={{ objectFit: "cover" }} />
      </div>
      <div className="absolute left-0 top-0 z-0 hidden size-full lg:block">
        <Image src="/images/png/mobile-back.png" fill priority sizes="100vw" alt="워시펀 세차장 솔루션 모바일 배경" quality={90} style={{ objectFit: "cover" }} />
      </div>
      <Header />
      <div className=" absolute left-72 top-72 flex w-full flex-col text-white xl:left-36 lg:left-1/2 lg:top-32 lg:-translate-x-1/2 md:mt-10">
        <div className="mb-16 flex flex-col gap-3 font-NotoSansKR lg:items-center">
          ...
          <h1 className="text-8xl font-bold tracking-wide lg:text-6xl">디지털 혁신</h1>
        </div>
