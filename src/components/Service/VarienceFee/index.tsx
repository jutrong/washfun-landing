...
const VarienceFee = () => {
  return (
    ...
    >
      <motion.div
        className="flex-1" >
        <Image src="/images/svg/varienceFee-mockup1.svg" alt="세차장 시간대별 변동 요금제 시각화" width={900} height={500} quality={100}
      ...
      <div className="flex-1 flex flex-col items-start text-black ml-20 h-full md:ml-0 md:mt-20">
        <div className="ml-5 mt-5 md:w-full md:flex md:flex-col md:items-center md:ml-0">
          <h2 className="text-5xl font-semibold flex flex-col gap-4 md:text-3xl md:items-center">
            <span>시간별 변동 요금제로</span>
            <span>매장 회전율 극대화 !</span>
          </h2>
