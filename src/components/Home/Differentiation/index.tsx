    ...
    <div className="flex flex-col items-center justify-center gap-10 bg-color p-20  text-black lg:p-10 md:px-2">
      <div className="mt-20 flex w-full justify-center md:mt-10">
        <h2 className="text-center text-[44px] font-semibold leading-tight text-gray md:text-3xl">
          워시펀은 다른 세차장과의 <br />
          <span className="text-gradient text-[58px] tracking-wider md:text-4xl">차이</span>를 만듭니다.
        </h2>
      </div>
      <div className="flex w-full flex-col gap-16 lg:gap-10 md:gap-4 md:px-4">
        ...
        >
          <div className="flex size-full items-center  xl:flex-col ">
            <div className="flex h-1/2 w-full justify-center gap-16 pb-10 md:w-16">
              ...
              <Image src="/images/png/iphone4.png" alt="" width={200} height={600} className="object-contain" />
            </div>
        ...
        >
          <div className="flex size-full flex-row-reverse items-center pt-20 lg:flex-col lg:gap-10 md:flex-col  ">
            <div className="flex h-1/2 w-full justify-center">
              <Image src="/images/png/data-iot3.png" alt="" width={400} height={1000} className="object-contain" />
            </div>
        ...
        >
          <div className="flex size-full items-center  py-20 lg:flex-col lg:gap-10 md:flex-col md:pb-0 ">
            <div className="flex h-1/2 w-full  justify-center gap-16 ">
              <Image src="/images/png/cost3.png" alt="" width={360} height={600} className="object-contain" />
            </div>
            <div className="relative flex h-1/2 w-full flex-col items-start gap-3 pt-0 md:pt-6">
              <p className="pb-4 text-4xl font-medium xl:text-3xl md:text-2xl">저렴한 도입 비용</p>
              <p className="text-2xl font-medium text-gray xl:text-xl md:text-sm">1. 기존 대비 30% 저렴한 신규 도입 비용</p>
              <p className="text-2xl font-medium text-gray xl:text-xl md:text-sm">2. 카드 제작, 카드 단말기 설치, 키오스크 설치와 유사한 기기 도입 비용</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="flex size-full flex-row-reverse items-center lg:flex-col lg:gap-10 md:flex-col ">
            <div className="flex h-1/2 w-full items-center justify-center gap-24 rounded-3xl p-12 shadow-primary-shadow md:gap-14">
              <Image src="/images/png/cycle.png" alt="순환 그래프" width={200} height={500} className="object-contain md:w-1/3" />
              <Image src="/images/png/iphone3.png" alt="아이폰 목업" width={180} height={600} className="object-contain md:w-1/3" />
