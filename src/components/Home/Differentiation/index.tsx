  ...
  return (
    <div className="flex flex-col items-center justify-center gap-10 bg-color p-20  text-black">
      <div className="mt-20 flex w-full justify-center">
        <h2 className="text-center text-[44px] font-semibold leading-tight text-gray">
          워시펀은 다른 세차장과의 <br />
          <span className="text-gradient text-[58px] tracking-wider">차이</span>를 만듭니다.
        </h2>
      </div>
      <div className="flex w-full flex-col gap-16">
        ...
        >
          <div className="flex size-full flex-row-reverse items-center pt-20  ">
            ...
            <div className="flex h-1/2 w-full flex-col items-center    ">
              ...
              <p className="mt-2 text-4xl font-medium">체계적인 매장관리 지원</p>
        ...
        <motion.div className=" flex w-full   justify-center  py-10 pt-20 "
          ...
          whileInView={{ opacity: 1, y: 0, transition: { duration: 2, delay: 0.2 } }}
        >
          <div className="flex size-full flex-row-reverse items-center ">
            ...
            <div className=" flex h-1/2 w-full flex-col items-center gap-3 pr-10">
