...
const Benefit = () => {
  return (
    <div className="flex flex-col items-center justify-center gap-10 bg-color py-20 text-black">
      <h2 className="mb-16 text-4xl font-bold tracking-widest">워시펀 가맹점 2024년 특별 혜택</h2>
      <div className="relative w-full">
        ...
        <div className="flex w-full flex-col gap-10 bg-lightPrimary4 px-40 py-10 pt-20">
          <p className="text-3xl font-semibold">마케팅 지원</p>
          <div className="cards my-10 flex w-full justify-between gap-10 ">
            <div className="card relative flex w-[420px] flex-col justify-between rounded-xl bg-white py-4 shadow-primary-shadow">
            ...
            <div className="card relative flex w-[420px]  flex-col justify-between rounded-xl bg-white py-4 shadow-primary-shadow">
              <p className="py-4 pl-10 text-left text-2xl font-medium">현수막 및 안내 스티커 제작 지원</p>
              <p className="absolute bottom-3 right-5 text-base font-medium text-red-500">130만원 상당</p>
              <div className="flex h-full items-center justify-center opacity-90">
                <Image src="/images/png/naver-blog.png" alt="블로그 홍보" width={160} height={200} />
              </div>
            ...
            <div className="card relative flex w-[420px]  flex-col justify-between rounded-xl bg-white py-4 shadow-primary-shadow">
              <p className="py-4 pl-10 text-left text-2xl font-medium">유튜브 홍보(쇼츠, 영상)</p>
          ...
          <p className="text-3xl font-semibold">도입 지원</p>
          <div className="cards my-10 flex w-full justify-between gap-10 ">
            <div className="card relative flex w-[420px]  flex-col justify-between rounded-xl bg-white py-4 shadow-primary-shadow">
              ...
              <div className="flex h-full items-center justify-center opacity-90">
                <Image src="/images/png/sale.png" alt="블로그 홍보" width={280} height={200} />
              </div>
            </div>
            <div className="card relative flex w-[420px]  flex-col justify-between rounded-xl bg-white py-4 shadow-primary-shadow">
              <p className="py-4 pl-10 text-left text-2xl font-medium">와이파이 공유기 무상 설치</p>
              <p className="absolute bottom-3 right-5 text-base font-medium text-red-500">130만원 상당</p>
              <div className="flex h-full items-center justify-center opacity-90">
                <Image src="/images/png/naver-blog.png" alt="블로그 홍보" width={160} height={200} />
              </div>
            ...
            <div className="card relative flex w-[420px]  flex-col justify-between rounded-xl bg-white py-4 shadow-primary-shadow">
              <p className="py-4 pl-10 text-left text-2xl font-medium">LTE 라우터 무상 지원</p>
              <p className="absolute bottom-3 right-5 text-base font-medium text-red-500">130만원 상당</p>
              <div className="flex h-full items-center justify-center opacity-90">
                <Image src="/images/png/naver-blog.png" alt="블로그 홍보" width={160} height={200} />
              </div>
