  ...
  return (
    <div className="flex flex-col items-center justify-center gap-10 bg-color py-20 font-NotoSansKR text-black">
      ...
      <div className="relative w-full">
        <svg className="absolute -top-20 left-0 w-full lg:hidden" viewBox="0 0 1440 100" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M0,50 C300,0 600,100 900,50 C1200,0 1440,100 1440,50 V100 H0 V50Z" fill="#F9FBFF" />
        </svg>
        <div className="flex w-full flex-col gap-20 bg-lightPrimary4 px-40 py-10 pt-20 md:bg-white md:px-0 md:py-5">
          <div>
            <p className="relative pl-10 text-3xl font-semibold md:pl-0 md:text-center ">마케팅 지원</p>
            <div className="my-10 flex w-full justify-between gap-10 lg:flex-col lg:items-center ">
              <div className="card relative flex w-[420px] flex-col justify-between rounded-lg bg-white py-4 shadow-primary-shadow md:w-[300px]">
          ...
          <div>
            <p className="pl-10 text-3xl font-semibold md:pl-0 md:text-center">도입 지원</p>
            <div className=" my-10 flex w-full justify-between gap-10 lg:flex-col lg:items-center ">
              <div className="card relative flex w-[420px]  flex-col justify-between rounded-lg bg-white py-4 shadow-primary-shadow md:w-[300px]">
        ...
        <svg className="absolute -bottom-24 left-0 w-full lg:hidden" viewBox="0 0 1440 100" fill="none" xmlns="http://www.w3.org/2000/svg">
