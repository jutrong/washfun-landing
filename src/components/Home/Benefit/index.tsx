...
const Benefit = () => {
  return (
    <div className="flex flex-col items-center justify-center gap-10 bg-color py-20 font-NotoSansKR text-black md:py-4">
      <h2 className=" w-full pl-48 font-OneMobilePOP text-4xl tracking-widest lg:pl-0 lg:text-center">2024년 특별 혜택</h2>
      <div className="relative w-full">
        {/* <svg className="absolute -top-20 left-0 -z-10 w-full lg:hidden" viewBox="0 0 1440 100" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M0,50 C300,0 600,100 900,50 C1200,0 1440,100 1440,50 V100 H0 V50Z" fill="#F9FBFF" />
        </svg> */}
        <div className="flex w-full flex-col gap-20 bg-lightPrimary4 px-4 py-28 xl:px-20 lg:px-10 md:bg-white md:px-0 md:py-5">
          <div>
            <p className="pl-4 text-center text-3xl font-semibold md:pl-0 md:text-center">마케팅 지원</p>
            <div className="my-10 flex flex-wrap justify-center gap-5">
              <div className="card relative flex w-[420px] flex-col justify-between rounded-lg bg-white py-4 shadow-primary-shadow md:w-[340px]">
                <p className="py-4 pl-10 text-left text-xl font-medium">블로그 홍보</p>
                <p className="absolute bottom-3 right-5 z-10 text-base font-medium text-red-500">130만원 상당</p>
          ...
          <div>
            <p className="pl-4 text-center text-3xl font-semibold md:pl-0 md:text-center">도입 지원</p>
            <div className="my-10 flex flex-wrap justify-center gap-5">
              <div className="card relative flex w-[420px]  flex-col justify-between rounded-lg bg-white py-4 shadow-primary-shadow md:w-[340px]">
              ...
              <div className="card relative flex w-[420px]  flex-col justify-between rounded-lg bg-white py-4 shadow-primary-shadow md:w-[340px]">
                ...
                <p className="absolute bottom-3 right-5 z-20 text-base font-medium text-red-500">20만원 상당</p>
                <div className="flex h-[180px] items-center justify-center opacity-90">
        ...
        {/* <svg className="absolute -bottom-24 left-0 -z-10 w-full lg:hidden" viewBox="0 0 1440 100" fill="none" xmlns="http://www.w3.org/2000/svg">
