...
const Recommend = () => {
  return (
    <div className="mb-52 flex flex-col px-52 font-Poppins text-black xl:mb-40 xl:px-0 md:px-8">
      ...
      <div className=" mt-28 flex size-full items-start justify-start gap-20 font-NotoSansKR xl:justify-center">
        <div className="flex items-center gap-44 xl:flex-col xl:items-center xl:gap-14">
          <div className=" flex justify-center  ">
            <Image src="/images/png/translate2.png" alt="recommend1" width={500} height={500} />
          </div>
